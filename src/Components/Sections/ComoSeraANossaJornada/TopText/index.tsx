...
export function TopText() {
  return (
    <div>
      ...
      <p className={styles.text3}>Com crianças e adolescentes adapta-se às necessidades específicas desses indivíduos, levando em consideração o estágio de desenvolvimento em que estão. Assim, alguns aspectos ganham relevância:</p>
    </div>
  )
}

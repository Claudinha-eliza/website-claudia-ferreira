...
export function TopText() {
  return (
    <div>
      ...
      <p className={styles.text2}>Essencialmente, a psicanálise ajuda os pacientes a explorar as camadas mais profundas da mente através da fala, visando promover autoconhecimento e alívio de sintomas psicológicos.</p>
